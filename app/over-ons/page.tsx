...
export const metadata: Metadata = {
  title: "Over ons | Simple Cleaning Service",
  description:
    "Maak kennis met Simple Cleaning Service uit Borne. Persoonlijke service, duidelijke afspraken en professionele reiniging voor particulieren en bedrijven.",
};
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="bg-sky-950 text-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-6 py-3 text-sm sm:flex-row sm:items-center sm:justify-between lg:px-8">
          <p className="text-sky-100">
            Professionele reiniging in Borne en omgeving
          </p>
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex min-h-20 max-w-7xl items-center justify-between gap-6 px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-sky-600 font-black text-white shadow-lg shadow-sky-600/20">
              SCS
            </div>

            <div>
              <p className="font-black leading-tight tracking-tight text-slate-950">
                Simple Cleaning
              </p>
          ...
          <nav className="hidden items-center gap-8 text-sm font-semibold text-slate-700 md:flex">
            ...
            <Link href="/over-ons" className="text-sky-600">
              Over ons
            </Link>
          ...
          <Link
            href="/offerte"
            className="hidden items-center gap-2 rounded-full bg-sky-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-sky-600/20 transition hover:-translate-y-0.5 hover:bg-sky-700 sm:flex"
          >
            Offerte aanvragen
            <ArrowIcon />
          </Link>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:items-center lg:px-8">
          <div className="relative min-h-[430px] overflow-hidden rounded-[2.5rem] bg-sky-950 p-8 text-white shadow-xl sm:p-10">
            ...
            <div className="relative flex h-full min-h-[350px] flex-col justify-between">
              <div>
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-sky-500 text-2xl font-black">
                  SCS
                </div>
      ...
      <footer className="bg-slate-950 text-slate-300">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-sky-600 font-black text-white">
                SCS
              </div>
            ...
            <p className="mt-5 max-w-sm leading-7 text-slate-400">
              Professionele reiniging voor woningen en bedrijfspanden in Borne
              en omgeving.
            </p>
          </div>

          <div>
            <h3 className="font-black text-white">Navigatie</h3>
          ...
          <div>
            <h3 className="font-black text-white">Bedrijfsgegevens</h3>
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-6 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between lg:px-8">
            <p>
              © {new Date().getFullYear()} Simple Cleaning Service. Alle
